...
<body>
    <nav class="navbar navbar-default title1">
        ...
        <a class="navbar-brand" href="#"><b>Quizzx</b></a>
        </div>

        <!-- Collect the nav links, forms, and other content for toggling -->
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
        <ul class="nav navbar-nav navbar-left" >
            <li><a href="QUIZZX.php"><span class="glyphicon glyphicon-home" aria-hidden="true"></span>Home<span class="sr-only">(current)</span></a></li>
            <li><a href="Facts/Facts.html"><span class="glyphicon glyphicon-home" aria-hidden="true"></span>Facts<span class="sr-only">(current)</span></a></li>
            <li><a href="Moments/Moments.html"><span class="glyphicon glyphicon-home" aria-hidden="true"></span>Moments<span class="sr-only">(current)</span></a></li>
            <li <?php if(@$_GET['q']==1) echo'class="active"'; ?>><a href="welcome.php?q=1"><span class="glyphicon glyphicon-home" aria-hidden="true"></span>Quiz</a></li>
